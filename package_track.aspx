    ...
    <section class="content">
        ...
        <div class="primary">
            <div class="main">
                ...
                <br />
                <br />
                <asp:Label ID="HouseL" runat="server" Text="House "></asp:Label><asp:DropDownList ID="HouseID" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourcehouse" DataTextField="house_name" DataValueField="house_id" AppendDataBoundItems="True" OnSelectedIndexChanged="HouseID_SelectedIndexChanged"><asp:ListItem Text="" Value="0">--Choose house--</asp:ListItem></asp:DropDownList>
                <asp:Label ID="RoomL" runat="server" Text="Room No. "></asp:Label><asp:DropDownList ID="RoomID" runat="server" AutoPostBack="True" DataSourceID="SqlDataSourceroom" DataTextField="room_name" DataValueField="room_id" OnSelectedIndexChanged="RoomID_SelectedIndexChanged" AppendDataBoundItems="True"><asp:ListItem Text="" Value="0">--Choose room--</asp:ListItem></asp:DropDownList>
                ...
                <asp:SqlDataSource ID="SqlDataSourceroom" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnection %>" SelectCommand="SELECT [room_name], [room_id] FROM [room]">
                </asp:SqlDataSource>
                <br />
                <br />
