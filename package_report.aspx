<%@ Page Language="C#" AutoEventWireup="true" CodeFile="package_overview.aspx.cs" Inherits="key_addnew" %>
    ...
    <section id="content">
        ...
        <div id="primary">
            <div id="main" style ="height:500px; overflow:scroll">
               <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSourcePackage" ForeColor="#333333" GridLines="None" OnRowCommand="GridView1_RowCommand">
                ...
                <asp:SqlDataSource ID="SqlDataSourcePackage" runat="server" ConnectionString="<%$ ConnectionStrings:RMSConnection %>" SelectCommand="select s.student_fname as firstname, s.student_lname as lastname, h.house_name as house, r.room_name as room, p.description, p.delivery_date, p.pickup_date
from student s
